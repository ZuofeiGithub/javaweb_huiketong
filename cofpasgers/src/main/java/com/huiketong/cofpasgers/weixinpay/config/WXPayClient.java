...
import com.huiketong.cofpasgers.weixinpay.util.WXRequestUtil;
...
public class WXPayClient extends WXPay {
     ...
     * @throws Exception
     */
    public SortedMap<String, String> getNotifyParameter(HttpServletRequest request, HttpServletResponse response) throws Exception {
